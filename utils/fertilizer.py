fertilizer_dic = {
        ...
        <br/> Please consider the following suggestions:1. <i>Add sawdust or fine woodchips to your soil</i> – the carbon in the sawdust/woodchips love nitrogen and will help absorb and soak up and excess nitrogen.
